...
1. Проверка по email не обязательна.

2. Оставляем первый по телефону

3. Ожидается ассоциативный массив по ключам ready и errors, формат errors в виде массива ошибок.
